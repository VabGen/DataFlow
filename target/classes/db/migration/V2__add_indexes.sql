CREATE EXTENSION IF NOT EXISTS pg_trgm SCHEMA data_flow;
SET search_path TO data_flow;
CREATE INDEX employees_last_name_first_name_idx ON employee USING gin(first_name gin_trgm_ops, last_name gin_trgm_ops);
